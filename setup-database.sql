-- Plumbing Job Management System - Database Setup
-- Run this in Supabase SQL Editor to set up all tables and create test user profile
...
-- ===========================
-- 13. RLS Policies - INSERT/UPDATE/DELETE (WITH CHECK only)
-- ===========================
...
-- ===========================
-- This is the key part: creating the profile for test@agentcy.co.za / 123Test user
insert into public.profiles (
  ...
  'ab8f1ae0-0a90-4f25-ab34-10dfd8aaf675',  -- This is the auth user ID we created earlier
  'owner',
  'Test Owner',
  'test@agentcy.co.za',
  now(),
